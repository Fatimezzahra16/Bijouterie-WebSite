...
<body>
    <!-- Contenu spécifique à la page Nouveautés -->
<nav class="bg-white text-gray-800 py-4 px-8 shadow-sm fixed w-full z-50">
    ...
    <section class="header-background mt-16">
        ...
        <div class="hero-content h-full flex flex-col justify-center items-center text-center px-4">
            <h2 class="text-5xl md:text-6xl font-serif font-bold text-white mb-4">Nos Nouveautés</h2>
            <p class="text-xl text-white mb-8 max-w-2xl">Découvrez nos dernières créations</p>
        </div>
