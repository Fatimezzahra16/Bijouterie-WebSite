<?php
$collectionTitle = "Collection Or";
$collectionDescription = "Nos plus belles pièces en or 18 carats";
$collectionProducts = [
    ['nom' => 'Bague en Or', 'description' => 'Bague en or 18 carats avec diamant', 'prix' => 450, 'image' => '../images/bague-or.jpg'],
    ['nom' => 'Chaîne en Or', 'description' => 'Chaîne en or jaune 14 carats', 'prix' => 380, 'image' => '../images/chaine-or.jpg'],
    ['nom' => 'Bracelet en Or', 'description' => 'Bracelet élégant en or blanc', 'prix' => 520, 'image' => '../images/bracelet-or.jpg'],
    ['nom' => 'Boucles d\'Oreilles en Or', 'description' => 'Boucles d\'oreilles en or jaune', 'prix' => 290, 'image' => '../images/boucles-or.jpg'],
    ['nom' => 'Pendentif en Or', 'description' => 'Pendentif en or avec pierre précieuse', 'prix' => 410, 'image' => '../images/pendentif-or.jpg'],
    ['nom' => 'Alliance en Or', 'description' => 'Alliance simple en or 18 carats', 'prix' => 350, 'image' => '../images/alliance-or.jpg']
];
...
<body>
    ...
    <nav class="bg-white text-gray-800 py-4 px-8 shadow-sm fixed w-full z-50">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <ul class="hidden md:flex space-x-8">
                <li><a href="../index.php" class="nav-link hover-gold">Accueil</a></li>
                <li><a href="../index.php#collections" class="nav-link hover-gold">Collections</a></li>
                <li><a href="#" class="nav-link hover-gold">Bijoux</a></li>
                <li><a href="#" class="nav-link hover-gold">Montres</a></li>
                <li><a href="#" class="nav-link hover-gold">Cadeaux</a></li>
            </ul>
            ...
            <div class="flex items-center space-x-4">
                ...
                <button class="px-4 py-2 rounded-full border border-gray-300 hover:border-gold hover-gold transition">
                    <i class="fas fa-user mr-2"></i>Connexion
                </button>
                
                <button class="px-4 py-2 rounded-full gold-bg text-white hover:bg-yellow-600 transition">
    ...
    <!-- Hero Slider spécifique à la collection -->
    <section class="hero-slider">
        <img src="IMG-20250323-WA0006.jpg" class="active" alt="Bijou en or">
        <img src="IMG-20250328-WA0012.jpg" alt="Bijou en or">
        <img src="IMG-20250328-WA0016.jpg" alt="Bijou en or">
        <img src="IMG-20250328-WA0026.jpg" alt="Bijou en or">
        
        <div class="hero-overlay"></div>
        <div class="hero-content h-full flex flex-col justify-center items-center text-center px-4">
            <h1 class="text-4xl md:text-5xl font-serif font-bold text-white mb-4"><?= htmlspecialchars($collectionTitle) ?></h1>
            <p class="text-xl text-white mb-8 max-w-2xl"><?= htmlspecialchars($collectionDescription) ?></p>
            <button class="gold-bg text-white px-8 py-3 rounded-full hover:bg-yellow-600 transition font-medium">
                Découvrir
            </button>
        </div>
    ...
    <!-- Newsletter identique à la page d'accueil -->
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <img src="acebook-iconf.png" alt="Facebook" class="w-10 h-10 rounded-full border-2 border-black">
                    </a>
                    <a href="https://www.instagram.com" target="_blank">
                    <img src="instagram-icon.jpg" alt="Instagram" class="w-10 h-10 rounded-full border-2 border-black">
                    </a>
                    <a href="https://www.pinterest.com" target="_blank">
                      <img src="téléchargement.png" alt="pinterest" class="w-10 h-10 rounded-full border-2 border-black">
                      </a>
                    </div>
                </div>
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="hover-gold">Collections</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="#" class="hover-gold">Retours</a></li>
